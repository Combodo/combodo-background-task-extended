...
class DatabaseQueryService
{
	 ...
	 */
	public function ExecuteSQLQueriesByChunkWithTempTable(string $sClass, string $sSearchKey, string $sSqlSearch, array $aSqlApply, string $sKey, int $iChunkSize): bool
	{
	 ...
	 * @throws \OQLException
	 */
	public function GetSqlFromOQL($sOqlSearch): string
	{
	 ...
	 * @throws \MySQLHasGoneAwayException
	 */
	private function GetSelectedKeys(string $sSqlSearch, string $sKey, string $sProgress, int $iMaxChunkSize): array
	{
	 ...
	 * @throws \MySQLHasGoneAwayException
	 */
	private function CountSelectedKeys(string $sSqlSearch)
	{
